      ...
      <main className="container mx-auto px-4 py-20">
        <div className="max-w-4xl mx-auto text-center mb-20">
          <div className="mb-8 inline-block animate-float">
            <img src={solanaLogo} alt="Solana" className="h-32 w-32 mx-auto drop-shadow-[0_0_50px_rgba(153,69,255,0.8)]" />
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button 
              size="lg" 
              className="gradient-primary text-white font-bold px-12 py-7 rounded-xl text-lg hover:scale-105 transition-all duration-300 hover:shadow-[0_0_40px_rgba(153,69,255,0.6)] w-full sm:w-auto"
            >
            ...
            <Button 
              size="lg" 
              variant="outline"
              className="border-2 border-secondary text-foreground font-semibold px-12 py-7 rounded-xl text-lg hover:bg-secondary/10 hover:scale-105 transition-all duration-300 w-full sm:w-auto"
            >
              Learn More
            </Button>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
          <div className="glass-card rounded-2xl p-8 hover:scale-105 transition-all duration-300">
            ...
            <h3 className="text-xl font-bold mb-3 text-center">Connect Wallet</h3>
          ...
          <div className="glass-card rounded-2xl p-8 hover:scale-105 transition-all duration-300">
            ...
            <h3 className="text-xl font-bold mb-3 text-center">Claim Rewards</h3>
            <p className="text-muted-foreground text-center">
          ...
          <div className="glass-card rounded-2xl p-8 hover:scale-105 transition-all duration-300">
            <div className="w-16 h-16 rounded-full bg-solana-green/20 flex items-center justify-center mb-4 mx-auto">
              <TrendingUp className="h-8 w-8 text-solana-green" />
            </div>
            <h3 className="text-xl font-bold mb-3 text-center">Earn More</h3>
            <p className="text-muted-foreground text-center">
